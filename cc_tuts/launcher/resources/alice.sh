...
" in window 1
		...
		do script with command "cd /Users/cristian/holochain/Holochain---P2P-project/cc_tuts" in window 1
		do script with command "hc run --networked sim2h --agent-name Alice --port 8888
" in window 1
		end tell
		EOF
